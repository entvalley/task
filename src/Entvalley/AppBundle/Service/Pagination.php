...
class Pagination
{
     ...
     * @param PaginationUrlGenerator $urlGenerator
     */
    public function __construct($perPage, PaginationUrlGenerator $urlGenerator)
    {
        $this->perPage = max((int)$perPage, 0);
    ...
    public function getNextUrl()
    {
        ...
        return $this->urlGenerator->generate($this->getNextPage());
    }
    ...
    public function getPreviousUrl()
    {
        ...
        return $this->urlGenerator->generate($this->getPreviousPage());
    }
}
